...
public class FlyingEye : MonoBehaviour
{
    ...
    {
        // Note (Faliq): Based on the tutorial we set as the commented code
        // However, we cannot add something invalid to a UnityEvent and in this case, OnDeath() returns a void
